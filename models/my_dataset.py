...
class Dataset:
    def __init__(self, conf, device):
        ...
        self.near = conf.get_float('near', default=0.5)
        self.far = conf.get_float('far', default=1.5)
        ...
        object_bbox_min = np.array([-0.125, 0.75, -0.125, 1.0])
        object_bbox_max = np.array([ 0.125,  1.0,  0.125, 1.0])
